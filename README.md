...
*The elbow is soft — per-game box-score stats are a continuum, not naturally separated groups. Silhouette is highest at k=2 (0.36), but that just splits starters from bench; it falls to 0.18 at the shipped k=6 and flattens around 0.15–0.16 beyond it. k=6 is chosen for interpretability, not for peak silhouette: it yields six archetypes a basketball fan would recognize.*
